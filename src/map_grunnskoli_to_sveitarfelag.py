...
DEFAULT_MUNICIPALITY_CROSSWALK = [
    ...
    ("Stykkishólmsbær", "Sveitarfélagið Stykkishólmur", "harmonized", "Current official municipality name."),
    ...
    ("Sveitarfélagið Skagafjörður", "Skagafjörður", "harmonized", "Current official municipality name."),
